...
Правила:
- Пиши на русском
- Будь конкретным: указывай URL, классы уязвимостей, severity
- Если уязвимость исчезла — возможно, её пропатчили (отметь как позитивный тренд)
- Новые critical/high уязвимости = повышение уровня риска
- Если нет значимых изменений — так и пиши, не выдумывай
`
